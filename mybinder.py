    ...
    class APIMethod(object):
        ...
        def execute(self):
            ...
            while retries_performed < self.retry_count + 1:
                ...
                # Execute request
                try:
                    #print('media data is {}'.format(self.media_data))
                    ...
                    #print ('resp.request is {}'.format(resp.request))
                    #print ('resp.request.headers is {}'.format(resp.request.headers))
                    #print ('resp.request.body is {}'.format(resp.request.body))
